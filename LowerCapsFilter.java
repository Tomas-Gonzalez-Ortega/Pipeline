...
/**
* LowerCapsFilter will convert the string to lower case.
*/
public class LowerCapsFilter extends Filter {

  /**
  * LowerCapsFilter converts the string to lower case.
  * @param s the string to apply the filter's transformation to
  * @return a string whose value is the given string,
  *   with any capitalization converted to lower case. AKN: Javadoc
  */
